...
assert.equal(model.getObjectByName('puddingMesh').material.color.getHexString(),'55bbff');
assert.equal(model.getObjectByName('caramelMesh').material.color.getHexString(),'ee88aa');
assert.equal(createModel('jelly').getObjectByName('puddingMesh').material.color.getHexString(),'55bbff');
assert.equal(createModel('pudding').getObjectByName('puddingMesh').material.color.getHexString(),'ffc94f');
